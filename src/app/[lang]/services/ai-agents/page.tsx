// en slug of the agents service page. The other language lives at a different
...
export async function generateMetadata(): Promise<Metadata> {
  const m = getDictionary('en').verticals.agents.meta;
  return localizedMetadata({ page: 'agents', lang: 'en', title: m.title, description: m.description });
}

export default function Page({ params }: { params: { lang: string } }) {
  if (params.lang !== 'en') notFound();
  return <AgentsScreen lang="en" />;
}
