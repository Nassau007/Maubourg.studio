// en slug of the foundations service page. The other language lives at a different
...
export async function generateMetadata(): Promise<Metadata> {
  const m = getDictionary('en').verticals.foundations.meta;
  return localizedMetadata({ page: 'foundations', lang: 'en', title: m.title, description: m.description });
}

export default function Page({ params }: { params: { lang: string } }) {
  if (params.lang !== 'en') notFound();
  return <FoundationsScreen lang="en" />;
}
