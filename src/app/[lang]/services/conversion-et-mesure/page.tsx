// fr slug of the conversion service page. The other language lives at a different
...
export async function generateMetadata(): Promise<Metadata> {
  const m = getDictionary('fr').verticals.conversion.meta;
  return localizedMetadata({ page: 'conversion', lang: 'fr', title: m.title, description: m.description });
}

export default function Page({ params }: { params: { lang: string } }) {
  if (params.lang !== 'fr') notFound();
  return <ConversionScreen lang="fr" />;
}
