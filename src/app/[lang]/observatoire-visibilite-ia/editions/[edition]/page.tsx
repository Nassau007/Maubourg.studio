// One archived edition, in French. An edition is never overwritten: a new
...
export default function Page({ params }: { params: { lang: string; edition: string } }) {
  ...
  const edition = getEdition(params.edition);
  if (!edition) notFound();
  return <ObservatoryEditionScreen lang="fr" edition={edition} />;
}
