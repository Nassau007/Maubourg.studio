// Template 2, sidebar: wide reading column, a sticky CTA card follows the
// reader down the page instead of appearing at fixed points in the flow.
//
// No embedded or closing CTA here — the sidebar is always in view, so
// repeating the offer elsewhere on the page would be the same pitch twice.
// Best for the longer, multi-section articles where a reader might act
...
export default function ArticleBodySidebar({ article, lang }: { article: Article; lang: Locale }) {
      ...
      <div className="mx-auto mt-12 grid max-w-content items-start gap-12 px-5 pb-8 md:px-8 lg:mt-16 lg:grid-cols-[minmax(0,1fr)_300px] lg:gap-14">
        ...
        <aside className="min-w-0 lg:sticky lg:top-24">
          <div className="card card-hover">
            ...
            <p className="mt-2 text-[14px] leading-snug text-ink-600">{copy.cta.body}</p>
